...
namespace AssignmentOfDotnetCore.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        {
            new SelectListItem { Value = "Human Resource", Text = "Human Resource" },
            new SelectListItem { Value = "IT & Network", Text = "IT & Network" },
            new SelectListItem { Value = "Production", Text = "Production"  },
            new SelectListItem { Value = "R&D", Text = "R&D"  },
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.DepartmentList = new SelectList(Department, "Value", "Text");
            return View();
        }
        ...
        public IActionResult Edit(int? id)
        {
            ...
            ViewBag.DepartmentList = new SelectList(Department, "Value", "Text", selectedValue: Employee.Manager);
            if (Employee == null)
            {
                return NotFound();
            }
