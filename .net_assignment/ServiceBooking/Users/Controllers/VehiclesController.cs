...
namespace Users.Controllers
{
    ...
    public class VehiclesController : Controller
    {
        ...
        public VehiclesController(IVehicle vehicleManager, ICustomer customerManager)
        {
        ...
        public ActionResult Index(VehicleModel vehicle)
        {
        ...
        public ActionResult Details(int? id)
        {
            ...
            VehicleModel vehicle = _vehicleManager.GetVehicle(id);
            if (vehicle == null)
            {
                return HttpNotFound();
            }
