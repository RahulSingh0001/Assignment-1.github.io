...
namespace Data.Repository
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        {
            IEnumerable<CustomerModel> customersEntities =
                Mapper.Map<IEnumerable<CustomerModel>>(_dbContext.Customers);
            return customersEntities;
        }

        public CustomerModel GetCustomer(int? Id)
        {
            CustomerModel customersEntitie = Mapper.Map<CustomerModel>(_dbContext.Customers.Find(Id));
