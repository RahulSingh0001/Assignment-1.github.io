...
namespace Dealer.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ICustomer customerManager)
        {
        ...
        public ActionResult Details(int? id)
        {
            ...
            CustomerModel customer = _customerManager.GetCustomer(id);
            if (customer == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,Name,Address1,Address2,Zipcode,PhoneNo,HomePhone,EmailId,Password")] CustomerModel customer)
        {
            // Exception handling
            try
            {
