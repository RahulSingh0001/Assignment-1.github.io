...
namespace Dealer.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        public MechanicsController(IMechanic mechanicManager)
        {
        ...
        public ActionResult Index(MechanicModel mechanic)
        {
            // Exception Handling
            try
            {
            ...
            var mechanics = new MechanicModel()
            {
                mechaniclist = _mechanicManager.GetAllMechanic()
            };
        ...
        public ActionResult Details(int? id)
        {
            ...
            MechanicModel mechanic = _mechanicManager.GetMechanic(id);
            if (mechanic == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(MechanicModel mechanic)
        {
            // Exception handling
            try
            {
