...
namespace Dealer.Controllers
{
    public class BookingController : Controller
    {
        ...
        public BookingController(IBooking bookingManager, IService serviceManager, IVehicle vehicleManager)
        {
        ...
        public ActionResult Index(BookingModel booking)
        {
            ...
            try
            {
                VehicleModel vehicle = _vehicleManager.GetAllVehicle().Where(a => a.VehicleId == booking.VehicleId).First();
        ...
        public ActionResult ChangeStatus(int? id)
        {
            ...
            BookingModel booking = _bookingManager.GetBooking(id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ChangeStatus(BookingModel booking)
        {
            // Exception handling
            try
            {
